...
class vanillaCPA(vanillaVAE):
    """
    This class extends vanillaVAE with a CPA-like approach of disentangling covariate effects in the latent space in a linear fashion.
